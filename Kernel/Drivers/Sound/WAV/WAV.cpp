...
namespace Audio::WAV
{
    Common::Optional<const ChunkHeader*> find_chunk(const ChunkHeader* header, std::size_t length, const char* str)
    {
    ...
    Common::Optional<Metadata> read_metadata(const uint8_t* wavData, std::size_t length)
    {
        ...
        Common::Optional<const ChunkHeader*> fmtChunkOpt = find_chunk(chunkHeader, remaining, "fmt ");
        ...
        Common::Optional<const ChunkHeader*> dataChunkOpt = find_chunk(chunkHeader, remaining, "data");
